...
('-5', 1, '-5', 'OR:9000', NULL, 'originarios:1:3', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);         
...
('-12', 1, '-5', '-5', 'originarios:1:3', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, 1, NULL, NULL);      
...
('-5', '-5', 'OR:9000', 'originarios:1:3', TIMESTAMP '2016-05-31 20:31:50.081', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);               
...
('-6', 'originarios:1:3', '-5', '-5', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-05-31 20:31:50.081', TIMESTAMP '2016-05-31 20:31:50.092', 11, NULL),
('-11', 'originarios:1:3', '-5', '-5', 'autuacao', '-12', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL); 
...
('-12', 'originarios:1:3', 'autuacao', '-5', '-5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);          
