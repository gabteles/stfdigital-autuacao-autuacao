...
('-14', 1, '-14', 'OR:9001', NULL, 'originarios:1:3', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-21', 1, '-14', '-14', 'originarios:1:3', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, 1, NULL, NULL);      
...
('-14', '-14', 'OR:9001', 'originarios:1:3', TIMESTAMP '2016-05-31 21:15:42.505', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);      
...
('-15', 'originarios:1:3', '-14', '-14', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-05-31 21:15:42.505', TIMESTAMP '2016-05-31 21:15:42.506', 1, NULL),
('-20', 'originarios:1:3', '-14', '-14', 'autuacao', '-21', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL);
...
('-21', 'originarios:1:3', 'autuacao', '-14', '-14', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);              
