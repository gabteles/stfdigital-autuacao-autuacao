...
('-32', 1, '-32', 'OR:9002', NULL, 'originarios:1:3', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-39', 1, '-32', '-32', 'originarios:1:3', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-06-02 15:15:01.968', NULL, NULL, 1, NULL, NULL);      
...
('-32', '-32', 'OR:9002', 'originarios:1:3', TIMESTAMP '2016-06-02 15:15:01.967', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);      
...
('-33', 'originarios:1:3', '-32', '-32', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-06-02 15:15:01.967', TIMESTAMP '2016-06-02 15:15:01.967', 0, NULL),
('-38', 'originarios:1:3', '-32', '-32', 'autuacao', '-39', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-06-02 15:15:01.967', NULL, NULL, NULL);
...
('-39', 'originarios:1:3', 'autuacao', '-32', '-32', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-06-02 15:15:01.968', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);              
