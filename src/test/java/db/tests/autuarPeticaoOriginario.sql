...
('-32', 1, '-32', 'OR:9002', NULL, 'originarios:1:5', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-39', 1, '-32', '-32', 'originarios:1:5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-06-02 15:15:01.968', NULL, NULL, 1, NULL, NULL);      
...
('-38', 'originarios:1:5', '-32', '-32', 'autuacao', '-39', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-06-02 15:15:01.967', NULL, NULL, NULL);
...
('-39', 'originarios:1:5', 'autuacao', '-32', '-32', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-06-02 15:15:01.968', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);              
