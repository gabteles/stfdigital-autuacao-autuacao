...
('-23', 1, '-23', 'OR:9003', NULL, 'originarios:1:3', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);           
...
('-30', 1, '-23', '-23', 'originarios:1:3', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, 1, NULL, NULL);      
...
('-23', '-23', 'OR:9003', 'originarios:1:3', TIMESTAMP '2016-06-02 15:15:40.624', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);             
...
('-24', 'originarios:1:3', '-23', '-23', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-06-02 15:15:40.624', TIMESTAMP '2016-06-02 15:15:40.625', 1, NULL),
('-29', 'originarios:1:3', '-23', '-23', 'autuacao', '-30', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, NULL);               
...
('-30', 'originarios:1:3', 'autuacao', '-23', '-23', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);  
