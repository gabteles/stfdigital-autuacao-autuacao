...
('-23', 1, '-23', 'OR:9003', NULL, 'originarios:1:5', NULL, 'autuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);           
...
('-30', 1, '-23', '-23', 'originarios:1:5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, 1, NULL, NULL);      
...
('-29', 'originarios:1:5', '-23', '-23', 'autuacao', '-30', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, NULL);               
...
('-30', 'originarios:1:5', 'autuacao', '-23', '-23', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-06-02 15:15:40.625', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);  
