...
import {AutuacaoRecursalService, AutuarProcessoRecursalCommand, ParteDto} from "autuacao/recursal/autuacao/recursal/autuacao-recursal.service";

import {Classe, Preferencia, Assunto} from "autuacao/services/model";
