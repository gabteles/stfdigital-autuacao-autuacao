create table autuacao.classe_originaria (sig_classe varchar2(6) not null, nom_classe varchar2(80) not null, constraint pk_classe_originaria primary key (sig_classe));
...
alter table autuacao.processo add constraint fk_classe_originaria_proc foreign key (sig_classe) references autuacao.classe_originaria(sig_classe);
