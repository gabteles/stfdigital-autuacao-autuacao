...
create table autuacao.processo (seq_processo number not null, seq_protocolo number not null, sig_classe varchar2(6) not null, tip_status varchar2(15) not null, constraint pk_processo primary key (seq_processo));
