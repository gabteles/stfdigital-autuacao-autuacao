...
('-14', 1, '-14', 'OR:9001', NULL, @proc_def_id_, NULL, 'autuar-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-14', '-14', 'OR:9001', @proc_def_id_, TIMESTAMP '2016-05-31 21:15:42.505', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);      
...
('-15', @proc_def_id_, '-14', '-14', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-05-31 21:15:42.505', TIMESTAMP '2016-05-31 21:15:42.506', 1, NULL),
('-20', @proc_def_id_, '-14', '-14', 'autuar-originario', '-21', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL);
...
('-21', @proc_def_id_, 'autuar-originario', '-14', '-14', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);              
