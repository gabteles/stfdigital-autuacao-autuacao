...
('-14', 1, '-14', 'OR:9001', NULL, 'originarios:1:5', NULL, 'autuar-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);  
...
('-21', 1, '-14', '-14', 'originarios:1:5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuar-originario', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, 1, NULL, NULL);      
...
('-20', 'originarios:1:5', '-14', '-14', 'autuar-originario', '-21', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL);
...
('-21', 'originarios:1:5', 'autuar-originario', '-14', '-14', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 21:15:42.506', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);              
