...
('-5', 1, '-5', 'OR:9000', NULL, 'originarios:1:5', NULL, 'autuar-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);         
...
('-12', 1, '-5', '-5', 'originarios:1:5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuar-originario', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, 1, NULL, NULL);      
...
('-11', 'originarios:1:5', '-5', '-5', 'autuar-originario', '-12', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL); 
...
('-12', 'originarios:1:5', 'autuar-originario', '-5', '-5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);          
