...
(9006, 9000, 'Maria da Silva', 'ATIVO'),
(9007, 9000, 'Paula Matos', 'PASSIVO');
...
('-5', 1, '-5', 'OR:9000', NULL, @proc_def_id_, NULL, 'autuar-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);         
...
('-12', 1, '-5', '-5', @proc_def_id_, STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', 'autuar-originario', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, 1, NULL, NULL);      

INSERT INTO PUBLIC.ACT_RU_IDENTITYLINK(ID_, REV_, GROUP_ID_, TYPE_, USER_ID_, TASK_ID_, PROC_INST_ID_, PROC_DEF_ID_) VALUES
('-13', 1, 'autuador', 'candidate', NULL, '-12', NULL, NULL);    
...
('-5', '-5', 'OR:9000', @proc_def_id_, TIMESTAMP '2016-05-31 20:31:50.081', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);               
...
('-6', @proc_def_id_, '-5', '-5', 'inicio', NULL, NULL, STRINGDECODE('Enviar Peti\u00e7\u00e3o Digital'), 'startEvent', NULL, TIMESTAMP '2016-05-31 20:31:50.081', TIMESTAMP '2016-05-31 20:31:50.092', 11, NULL),
('-11', @proc_def_id_, '-5', '-5', 'autuar-originario', '-12', NULL, STRINGDECODE('Autuar Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL); 
...
('-12', @proc_def_id_, 'autuar-originario', '-5', '-5', STRINGDECODE('Autuar Processo Origin\u00e1rio'), NULL, 'AUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 20:31:50.092', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);          
...
('-13', 'autuador', 'candidate', NULL, '-12', NULL); 