...
import br.jus.stf.autuacao.originarios.interfaces.ProcessoOriginarioEventHandler;
...
public class RabbitConfiguration {
	...
	public static final String PETICAO_ORIGINARIO_QUEUE = "autuacao.peticao.recebida";
	...
	public List<Binding> bindings() {
		return Arrays.asList(
			BindingBuilder.bind(new Queue(PETICAO_ORIGINARIO_QUEUE)).to(exchange()).with(PETICAO_REGISTRADA_ROUTE)
		);
	}
